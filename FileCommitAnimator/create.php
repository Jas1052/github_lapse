...
echo "--File Details--\n";
$name = "thomaslai1"; //readline("Repository Owner Username: ");
$repo = "wheelsharealpha"; //readline("Repository Name: ");
$filePath = "/app/src/main/java/com/example/a2017tlai/wheelsharealpha/RequestActivity.java";//readline("File Path: ");
echo "\n";
